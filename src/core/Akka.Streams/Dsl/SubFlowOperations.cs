...
namespace Akka.Streams.Dsl
{
    ...
    public static class SubFlowOperations
    {
        ...
        /// </para>
        /// <para>
        /// For logging signals (elements, completion, error) consider using the <see cref="Log{TOut,TMat,TClosed}"/> stage instead,
        ...
        ///  <summary>
        /// Allows a faster upstream to progress independently of a slower subscriber by aggregating elements into batches
        /// until the subscriber is ready to accept them.For example a batch step might concatenate 
